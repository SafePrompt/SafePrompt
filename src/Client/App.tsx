    ...
    return (
        ...
        <Router>
            ...
            <Routes>
                ...
                <Route path="/" element={<Login key = 'Login' configFunc = {setConfiguration} orgFunc={setOrg}/>} />

                {/* <Route path="/" element={<Landing key = 'Landing'/>} /> */}
                <Route path="/signup" element={<Signup key = 'Signup' orgFunc={setOrg} />} />
                <Route path="/adminview" element={<AdminView key = 'AdminView 'initialEntries = {config.entries} settings = {settings} config = {config} org = {orgKey}/>}/>
            </Routes>
        </Router>
        </div>
