...
describe("SSN Unit Test", () => {
    ...
    it("Should find multiple SSN's in string", () => {
        res.locals!.prompt =
            "183-84-8532 and the other is 842-83-7543 as well as 851-83-8523";
        ssn(req as Request, res as Response, next as unknown as NextFunction);
        expect(res.locals!.object).toEqual({
            ssn: ["183-84-8532", "842-83-7543", "851-83-8523"],
        });
        expect(next).toHaveBeenCalled();
    });
    ...
    it("Should pass blank object if ssn config is disabled", () => {
        res.locals!.config.ssn = false;
        res.locals!.prompt = "181-23-8232 hello this string ends with";
        ssn(req as Request, res as Response, next as unknown as NextFunction);
        expect(res.locals!.object).toEqual({});
        expect(next).toHaveBeenCalled();
    });
